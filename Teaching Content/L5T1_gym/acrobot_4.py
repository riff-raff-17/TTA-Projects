...
while running:
    ...
    # cover however long the frame took.
    # No keyboard control yet (Step 5) - apply a small constant test torque
    # so you can see the dynamics actually doing something.
    test_torque = 1.0
    time_to_simulate += dt_ms / 1000.0
    while time_to_simulate >= DT:
        theta1, theta2, theta1_dot, theta2_dot = step_physics(
            theta1, theta2, theta1_dot, theta2_dot, test_torque, DT
        )
        time_to_simulate -= DT
